...
export default function Card({ name, personal, birth, badge, avatarUrl, card, register }) {

  const [barcode, setBarcode] = useState('/')

  useEffect(() => {
      (async function () {
          setBarcode(await barcodeGenerator(`https://yourcompany.com/members/${personal}`))
      })();
  },[personal])
